...
public class CalculatorGUI extends javax.swing.JFrame {
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(bsub, javax.swing.GroupLayout.PREFERRED_SIZE, 71, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(layout.createSequentialGroup()
    ...
    private void bequalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bequalActionPerformed
        ...
        if(operator == "+"){
            ans = proxy.addIntegers(num1, num2);
            //ans = num1 + num2;
        }
        if(operator == "-"){
            ans = proxy.subIntegers(num1, num2);
            //ans = num1 - num2;
        }
        if(operator == "*"){
            ans = proxy.mulIntegers(num1, num2);
            //ans = num1  * num2;
        }
        if(operator == "/"){
            ans = proxy.divIntegers(num1, num2);
            //ans = num1 / num2;
        }
        t1.setText("" + ans);
    ...
    CalculatorWebService webSerive;
